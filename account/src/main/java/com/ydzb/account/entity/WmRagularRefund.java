...
public class WmRagularRefund extends BaseEntity<Long> implements IWmPeriodicProductRefund {
    private static final long serialVersionUID = 1L;

    public static final int EXPIRE_NOTLAST = 0  ;   //非最后一期
    public static final int EXPIRE_LAST = 1;
    public static final int ORG_RAGULAR = 0;    //机构-定存
    public static final int ORG_ORG = 1;    //机构-机构宝
    public static final int ORG_FREE = 2;   //机构-自由定存
    public static final int STATE_NOTREFUND = 0 ;   //状态-未还
    public static final int STATE_REFUND = 1;   //状态-已还
