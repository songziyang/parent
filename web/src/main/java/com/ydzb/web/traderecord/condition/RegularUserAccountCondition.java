...
public class RegularUserAccountCondition {
    ...
    public List<SearchFilter> getAndFilters() {
        ...
        if (days != null) {
            filters.add(SearchFilterHelper.newCondition("productInfo.cylcleDays", SearchOperator.eq, days));
        }

        if (expireMode!=null&& expireMode >= 0) {
            filters.add(SearchFilterHelper.newCondition("expireMode", SearchOperator.eq, expireMode));
        }
    ...
    public Map<String, Object> getSqlFilter() {
        ...
        if (expireMode != null) {
            filter.put("expireMode", expireMode);
        }
