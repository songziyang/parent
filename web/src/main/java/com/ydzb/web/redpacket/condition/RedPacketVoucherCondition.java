 ...
 * @author sy
 */
public class RedPacketVoucherCondition {
    ...
    public List<SearchFilter> getAndFilters() {
        ...
        if (StringUtils.isNotEmpty(activityBeginDate)) {
            filters.add(SearchFilterHelper.newCondition("beginTime",
                    SearchOperator.gte, DateUtil.getSystemTimeDay(activityBeginDate)));
        }

        if (StringUtils.isNotEmpty(activityFinishDate)) {
            filters.add(SearchFilterHelper.newCondition("endTime",
