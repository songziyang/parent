...
<head>
    ...
    <script type="text/javascript">
        ...
        function exprotExcel(condition) {
            var url = "${ctx}/recharge/rechargetotal/exportDetail/" + condition
...
<div class="page-header position-relative">
    ...
    <div class="header-buttons">
        <a class="sidebar-toggler" href="#"> <i class="fa fa-arrows-h"></i>
                ...
                href="${ctx}/recharge/rechargetotal/detail"> <i
...
<!-- /Page Header -->
<!-- Page Body -->
<form action="${ctx}/recharge/rechargetotal/detail"
            ...
            <div class="col-xs-12 col-md-12">
                ...
                <div class="widget">
                    <div class="widget-header  with-footer">
                        <span class="widget-caption">充值详细列表</span>
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                ...
                                <c:forEach items="${page.content}" var="detail"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <fmt:formatNumber value="${detail.allRecharge}" type="number"/>
                                        </td>
                                        <td>
                                            <fmt:formatNumber value="${detail.alliWthdraw}" type="number"/>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
