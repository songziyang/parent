											...
											<tr>
												...
												<td>
													<a href="${ctx}/userinfo/user/listUserInfo/<c:out value='${usermoney.user.id}'/>"
													   data-simpletooltip="init" title='<c:out value="${usermoney.user.remark}" />'
													   <c:if test="${not empty usermoney.user.remark}">style='color: red;'</c:if>>
														<c:out value="${usermoney.totalFund}" />
													</a>
												</td>
												...
												<td align="center"><a
													href='${ctx}/userinfo/redeemApply/findoperation/<c:out value="${usermoney.user.id}"/>'
													class="btn btn-info btn-xs edit"><i
														class="fa fa-file-text"></i>资金</a> <a
													href='${ctx}/userinfo/redeemApply/buniesstake/<c:out value="${usermoney.user.id}"/>'
													class="btn btn-info btn-xs edit"><i
														class="fa fa-file-text"></i>交易</a> <a
													href='${ctx}/userinfo/redeemApply/finduserredpack/<c:out value="${usermoney.user.id}"/>'
													class="btn btn-info btn-xs edit"><i
														class="fa fa-file-text"></i>红包</a> <!-- 
														 <a
													href='${ctx}/userinfo/redeemApply/findcontributebyid/<c:out value="${usermoney.user.id}"/>'
													class="btn btn-info btn-xs edit"><i
