...
<body>
	...
	<div class="page-header position-relative">
		...
		<div class="header-buttons">
			...
			<a class="refresh" id="refresh-toggler"
				href="${ctx}/userinfo/businessUser/list"><i
	...
	<!-- /Page Header -->
	<!-- Page Body -->
	<form action="${ctx}/userinfo/businessUser/list" method="post"
				...
				<div class="col-xs-12 col-md-12">
					...
					<div class="widget">
						<div class="widget-header  with-footer">
							<span class="widget-caption">业务员列表</span>
							<div class="widget-buttons">
									...
									<tbody style="font-size: 12px;">
										<c:forEach items="${page.content}" var="userInfo"
											...
											<tr>
												...
												<td>
													<c:choose>
														<c:when test="${user.referralNum ne 0 }">
															<a href="${ctx}/userinfo/referralUser/list?referralMobile=${user.mobile}"><c:out value="${user.referralNum}" /></a>
														</c:when>
														<c:otherwise>0</c:otherwise>
													</c:choose>
												<td>
													<c:out value="${totalFunds[status.index] eq null? 0: totalFunds[status.index]}" />
												</td>
											</tr>
										</c:forEach>
									</tbody>
