...
<head>
    ...
    <script type="text/javascript">
        ...
        function exprotExcel(condition) {
            var url = "${ctx}/userrecharge/recharge/exportExcel/" + condition
...
<div class="page-header position-relative">
    ...
    <div class="header-buttons">
        <a class="sidebar-toggler" href="#"> <i class="fa fa-arrows-h"></i>
                ...
                href="${ctx}/userrecharge/recharge/listRecharge"> <i
...
<!-- /Page Header -->
<!-- Page Body -->
<form action="${ctx}/userrecharge/recharge/listRecharge" method="post"
            ...
            <div class="col-xs-12 col-md-12">
                ...
                <div class="widget">
                    <div class="widget-header  with-footer">
                        <span class="widget-caption">手动充值管理</span>
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                ...
                                <c:forEach items="${page.content}" var="userRecharge"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <fmt:formatNumber  value="${empty userRecharge.fund ? 0 : userRecharge.fund}" type="number"/>
                                        </td>
                                        <td>
                                            <fmt:formatNumber  value="${empty userRecharge.usableFund ? 0 : userRecharge.usableFund}" type="number"/>
                                        </td>
                                        <td><c:out value="${userRecharge.admin.realname}"/></td>
                                        <td><fmt:formatDate value="${userRecharge.operateDate}"
                                                            pattern="yyyy年MM月dd日 HH时mm分"/></td>
                                        <td><c:out value="${userRecharge.remark}"/></td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
