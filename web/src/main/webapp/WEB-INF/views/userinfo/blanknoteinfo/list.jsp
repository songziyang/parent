...
<body>
	...
	<div class="page-header position-relative">
		...
		<div class="header-buttons">
			<a class="sidebar-toggler" href="#"> <i class="fa fa-arrows-h"></i>
				...
				href="${ctx}/userinfo/blankNoteInfo/listBlankNoteInfo"> <i
	...
	<!-- /Page Header -->
	<!-- Page Body -->
	<form action="${ctx}/userinfo/blankNoteInfo/listBlankNoteInfo"
				...
				<div class="col-xs-12 col-md-12">
					...
					<div class="widget">
						<div class="widget-header  with-footer">
							<span class="widget-caption">银多2.0+投资列表</span>
							<div class="widget-buttons">
										...
										<c:forEach items="${page.content}" var="userMoney"
											...
											<tr>
												...
												<td>
													...
													<a href="${ctx}/userinfo/user/listUserInfo/<c:out value='${userMoney.user.id}'/>"
													   data-simpletooltip="init" title='<c:out value="${userMoney.user.remark}" />'
													   <c:if test="${not empty userMoney.user.remark}">style='color: red;'</c:if>>
												...
												<td>
													<a href="${ctx}/userinfo/user/listUserInfo/<c:out value='${userMoney.user.id}'/>"
													   data-simpletooltip="init" title='<c:out value="${userMoney.user.remark}" />'
													   <c:if test="${not empty userMoney.user.remark}">style='color: red;'</c:if>>
														<c:out value="${userMoney.user.mobile}" />
													</a>
												</td>
												<td><fmt:formatNumber value="${userMoney.whitenoteTotalFund}" type="number"/> </td>
												<td><fmt:formatNumber value="${userMoney.whitenoteUsableFund}" type="number"/> </td>
												<td width="200px" align="center"><a
													href='${ctx}/userinfo/user/listUserInfo/<c:out value="${userMoney.user.id}" />'
