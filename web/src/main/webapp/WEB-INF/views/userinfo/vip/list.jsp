...
<head>
    ...
    <script type="text/javascript">
        ...
        function exprotExcel(condition) {
            var url = "${ctx}/userinfo/vipbirthday/exportExcel/" + condition
...
<div class="page-header position-relative">
    ...
    <div class="header-buttons">
        <a class="sidebar-toggler" href="#"> <i class="fa fa-arrows-h"></i>
                ...
                href="${ctx}/userinfo/vipbirthday/listVipBirthday"> <i
...
<!-- /Page Header -->
<!-- Page Body -->
<form action="${ctx}/userinfo/vipbirthday/listVipBirthday" method="post"
            ...
            <div class="col-xs-12 col-md-12">
                            ...
                            <div class="widget-body">
                                <div class="form-inline" role="form">
                                    <div class="form-group">
                                        <label class="control-label no-padding-right"></label>日期：
                                        <input type="text" name="birthdayDate" class="form-control" tabindex="1"
                                               style="padding-left: 50px;" maxlength="40"
                                               onfocus="WdatePicker({skin:'twoer',dateFmt:'MMdd'})">
                                    </div>
                ...
                <div class="widget">
                    <div class="widget-header  with-footer">
                        <span class="widget-caption">VIP生日提醒</span>
