...
<body>
	...
	<form action="${ctx}/userinfo/user/rechargeUser" method="post" id="editForm" name="editForm">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							<span class="form-group input-icon icon-right"> <label>充值金额<sup
									style="color: red;">&nbsp;*</sup>：
