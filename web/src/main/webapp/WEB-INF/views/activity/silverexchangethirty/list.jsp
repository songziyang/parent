...
//                window.location.href ="http://localhost:8080/static/download/"+filename;
        ...
        function exprotExcel(condition) {
            var url = "${ctx}/activity/silverExchangeThirty/exportExcel/" + condition
            window.location.href = url;
        }
    </script>
</head>
...
<div class="page-header position-relative">
    ...
    <div class="header-buttons">
        ...
        <a class="refresh" id="refresh-toggler" href="${ctx}/activity/silverExchangeThirty/list">
...
<!-- /Page Header -->
<!-- Page Body -->
<form action="${ctx}/activity/silverExchangeThirty/list" method="post" id="listForm" name="listForm">
    <div class="page-body">
        <div class="row">
                        ...
                        <div class="widget collapsed">
                            ...
                            <div class="widget-body">
                                <div class="form-inline" role="form">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label no-padding-right">发放种类</label>
                                        <select class="form-control" name="category" style="width: 200px;" id="category">
                                    ...
                                    <span id="selectItems">
                                        <div class="form-group">
                                            ...
                                            <option value="0">抽奖兑换</option>
                                            <option value="1">银多币兑换</option>
                                        </select>
                                        </div>
                                        <div class="form-group">
                                ...
                                <c:forEach items="${page.content}" var="silver" varStatus="status">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <c:out value="${silver.user.username}"/></td>
                                        ...
                                        <td><c:out value="${silver.productName}"/></td>
                                        ...
                                        <td><fmt:formatDate value="${silver.createdDate}" pattern="yyyy年MM月dd日 HH时mm分"/></td>
                                        <c:if test="${category eq 1}">
                                            <td><fmt:formatDate value="${silver.sendedDate}" pattern="yyyy年MM月dd日 HH时mm分"/></td>
                                            <c:if test="${silver.status eq 1 || silver.status eq 2}">
                                                <td width="200px" align="center">
                                                    <c:choose>
                                                        <c:when test="${silver.status eq 1}">
                                                            <a onclick="auditSuccess('${ctx}/activity/silverExchangeThirty/auditSuccess/<c:out value="${silver.id}"/>/2')"
                                                               class="btn btn-success btn-xs edit">
                                                                <i class="fa fa-edit"></i>确认发货
                                                            </a>
                                                            &nbsp;&nbsp;
                                                            <a onclick="auditFailure('${ctx}/activity/silverExchangeThirty/auditFailure/<c:out value="${silver.id}"/>')"
                                                               class="btn btn-danger btn-xs edit">
                                                                <i class="fa fa-edit"></i>取消订单
                                                            </a>
                                                        </c:when>
                                                        <c:when test="${silver.status eq 2}">
                                                            <a onclick="auditSuccess('${ctx}/activity/silverExchangeThirty/auditSuccess/<c:out value="${silver.id}"/>/3')"
                                                               class="btn btn-success btn-xs edit">
