...
<div class="page-header position-relative">
    ...
    <div class="header-buttons">
        <a class="sidebar-toggler" href="#"> <i class="fa fa-arrows-h"></i>
                ...
                href="${ctx}/activity/topRagularUser/list"> <i
            ...
            <div class="col-xs-12 col-md-12">
                <div class="widget">
                    <div class="widget-header  with-footer">
                        <span class="widget-caption">定存排行</span>
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                ...
                                <c:forEach items="${page}" var="user" varStatus="status">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="${ctx}/userinfo/user/listUserInfo/<c:out value='${user.userId}'/>"
                                        ...
                                        <td>${user.buyFund}</td>
                                        <td>${user.totalFund}</td>
                                        <td>${user.usableFund}</td>
