...
<head>
    ...
    <script type="text/javascript">
        ...
        function exprotExcel(condition) {
            var url = "${ctx}/traderecord/ragular/exportRagularRecord/" + condition
...
<div class="page-header position-relative">
    ...
    <div class="header-buttons">
        ...
        </a> <a class="refresh" id="refresh-toggler" href="${ctx}/traderecord/ragular/listRagularRecored"> <i
...
<!-- /Page Header -->
<!-- Page Body -->
<form action="${ctx}/traderecord/ragular/listRagularRecored"
            ...
            <div class="col-xs-12 col-md-12">
                ...
                <div class="widget">
                    <div class="widget-header  with-footer">
                        <span class="widget-caption">定存宝赎交易记录</span>
