...
//                    window.location.href = "http://localhost:8080/static/download" + filename;
        ...
        function exprotExcel(condition) {
            var url = "${ctx}/traderecord/free/export/" + condition
...
<div class="page-header position-relative">
    ...
    <div class="header-buttons">
        ...
        </a> <a class="refresh" id="refresh-toggler" href="${ctx}/traderecord/free/list"> <i
...
<!-- /Page Header -->
<!-- Page Body -->
<form action="${ctx}/traderecord/free/list"
            ...
            <div class="col-xs-12 col-md-12">
                            ...
                            <div class="widget-body">
                                <div class="form-inline" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        产品天数：从 <input type="text" name="startDays" width="20px"
                                                      class="form-control" tabindex="1"
                                                      min="30" max="390"
                                                      required maxlength="3" > 到 <input
                                            type="text" name="endDays" class="form-control" tabindex="1"
                                            srequired maxlength="3"  width="50px"
                                            min="30" max="390">
                                    </div>
                ...
                <div class="widget">
                    <div class="widget-header  with-footer">
                        <span class="widget-caption">随心存交易记录</span>
