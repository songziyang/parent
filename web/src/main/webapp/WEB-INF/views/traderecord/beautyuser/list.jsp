...
<head>
    ...
    <script type="text/javascript">
        ...
        function exprotExcel(condition) {
            var url = "${ctx}/traderecord/beauty/exportEx/" + condition
...
<div class="page-header position-relative">
    ...
    <div class="header-buttons">
        <a class="sidebar-toggler" href="#"> <i class="fa fa-arrows-h"></i>
                ...
                href="${ctx}/traderecord/beauty/listBeautyUserAccount">
...
<!-- /Page Header -->
<!-- Page Body -->
<form action="${ctx}/traderecord/beauty/listBeautyUserAccount"
            ...
            <div class="col-xs-12 col-md-12">
                ...
                <div class="widget">
                    <div class="widget-header  with-footer">
                        <span class="widget-caption">美利金融已购记录</span>
