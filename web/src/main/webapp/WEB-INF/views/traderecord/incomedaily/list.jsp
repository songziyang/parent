...
<html lang="zh">
    <head>
        ...
        <script type="text/javascript">
            ...
            function exprotExcel(condition) {
                var url = "${ctx}/traderecord/incomeDaily/export/" + condition
    ...
    <div class="page-header position-relative">
        ...
        <div class="header-buttons">
            ...
            <a class="refresh" id="refresh-toggler" href="${ctx}/traderecord/incomeDaily/list">
    ...
    <!-- /Page Header -->
    <!-- Page Body -->
    <form action="${ctx}/traderecord/incomeDaily/list" method="post" id="listForm" name="listForm">
        <div class="page-body">
            <div class="row">
                <div class="col-xs-12 col-md-12">
                    ...
                    <div class="widget">
                        <div class="widget-header  with-footer">
                            <span class="widget-caption">用户每日收益</span>
                            <div class="widget-buttons">
