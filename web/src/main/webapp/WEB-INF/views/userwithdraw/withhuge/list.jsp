...
//                window.location.href = "http://localhost:8080/static/download"+ filename;
        ...
        function exprotExcel(condition) {
            var url = "${ctx}/userwithdraw/withhuge/exportExcel/" + condition
...
<div class="page-header position-relative">
    ...
    <div class="header-buttons">
        <a class="sidebar-toggler" href="#"> <i class="fa fa-arrows-h"></i>
                ...
                href="${ctx}/userwithdraw/withhuge/list"> <i
...
<!-- /Page Header -->
<!-- Page Body -->
<form action="${ctx}/userwithdraw/withhuge/list"
                            ...
                            <div class="widget-body">
                                <div class="form-inline" role="form">
                                    ...
                                    <div class="form-group" style="margin-left: 10px">
                                        <label class="control-label no-padding-right">操作日期</label> <input
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                ...
                                <c:forEach items="${page.content}" var="payback"
                                    ...
                                    <tr>
                                        ...
                                        <th><fmt:formatNumber value="${payback.withMoney}" type="number"/></th>
                                        <th><fmt:formatNumber value="${payback.ableMoney}" type="number"/></th>
                                        <th><fmt:formatDate value="${payback.opdate}" pattern="yyyy年MM月dd日 HH时mm分"/></th>
                                        </th>
                                    </tr>
                                </c:forEach>
                                </tbody>
