				...
				<div class="widget">
					...
					<div class="widget-body">
						<div id="registration-form">
							<form action="${ctx}/product/selfTradeLog/buy" id="editForm"
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="form-group">
											<span class="form-group input-icon icon-right"> <label>冻结金额<sup
													style="color: red;">&nbsp;*</sup>：：
											</label> <input type="text" class="form-control" tabindex="1"
												style="padding-left: 120px;" readonly="readonly"
												name="freezeMoney" value="${tradeLog.freezeMoney}">
											</span>
										</div>
									</div>
									...
									<div class="col-sm-6">
										<div class="form-group">
											<span class="form-group input-icon icon-right"> <label>投资金额<sup
													style="color: red;">&nbsp;*</sup>：
											</label> <input type="text" class="form-control" tabindex="1"
												style="padding-left: 120px;" name="tradeMoney"
												value="${tradeLog.tradeMoney}" maxlength="10"
												data-bv-stringlength-max="10"
												data-bv-stringlength-message="不能超过10个字"
												data-bv-regexp="true" data-bv-regexp-regexp="^\d+(\.\d+)?$"
												data-bv-regexp-message="格式错误" data-bv-lessthan="true"
												data-bv-lessthan-value="freezeMoney"
												data-bv-lessthan-message="投资金额应小于等于冻结金额" required>
											</span>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											<span class="form-group input-icon icon-right"> <label>投资日期<sup
													style="color: red;">&nbsp;*</sup>：
											</label> <input type="text" name="investDate" class="form-control"
