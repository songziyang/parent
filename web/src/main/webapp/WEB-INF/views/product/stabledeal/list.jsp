...
<body>
	...
	<div class="page-header position-relative">
		...
		<div class="header-buttons">
			...
			</a> <a class="refresh" id="refresh-toggler" href="${ctx}/product/stabledeal/listStableDeal"> <i
	...
	<!-- /Page Header -->
	<!-- Page Body -->
	<form action="${ctx}/product/stabledeal/listStableDeal" method="post"
				...
				<div class="col-xs-12 col-md-12">
					...
					<div class="widget">
						<div class="widget-header  with-footer">
							<span class="widget-caption">稳进宝交易记录</span>
							<div class="widget-buttons">
						...
						<div class="widget-body">
								...
								<table class="table table-hover table-striped table-bordered">
									...
									<tbody style="font-size: 12px;">
										<c:forEach items="${page.content}" var="stableDeal"
											varStatus="status">
											<c:set var="user" value="${stableDeal.user}" />
											<tr>
												<td class="table_no" width="80" align="center"></td>
												<td><c:out value="${stableDeal.stable.name}" /></td>
												<td>
													<c:choose>
												...
												<td><c:out value="${stableDeal.copies}" /></td>
												<td><fmt:formatDate value="${stableDeal.buyDate}"  pattern="yyyy年MM月dd日  HH:mm:ss" /></td>
												<td>
 													<c:choose>
 														<c:when test="${stableDeal.state eq 0}"><c:out value="未结算" /></c:when> 
 														<c:when test="${stableDeal.state eq 1}"><c:out value="已结算" /></c:when> 
 													</c:choose>
 												</td>
											</tr>
										</c:forEach>
