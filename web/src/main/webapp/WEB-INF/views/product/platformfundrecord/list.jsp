...
<div class="page-header position-relative">
    ...
    <div class="header-buttons">
        ...
        <a class="refresh" id="refresh-toggler" href="${ctx}/platform/fundrecord/list">
...
<!-- /Page Header -->
<!-- Page Body -->
<form action="${ctx}/platform/fundrecord/list" method="post" id="listForm" name="listForm">
    <div class="page-body">
        <div class="row">
