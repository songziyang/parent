...
//                window.location.href ="http://localhost:8080/static/download/"+filename;
        ...
        function exprotExcel(condition) {
            var url = "${ctx}/platform/silverLotteryThirtyStatistics/exportExcel/" + condition
...
<div class="page-header position-relative">
    ...
    <div class="header-buttons">
        ...
        <a class="refresh" id="refresh-toggler" href="${ctx}/platform/silverLotteryThirtyStatistics/list">
...
<!-- /Page Header -->
<!-- Page Body -->
<form action="${ctx}/platform/silverLotteryThirtyStatistics/list" method="post" id="listForm" name="listForm">
    <div class="page-body">
        <div class="row">
            <div class="col-xs-12 col-md-12">
                ...
                <div class="widget">
                    <div class="widget-header  with-footer">
                        <span class="widget-caption">活动抽奖列表</span>
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                ...
                                <c:forEach items="${page.content}" var="statistics" varStatus="status">
                                    <tr>
                                        ...
                                        <td><c:out value="${statistics.todayCount}"/></td>
