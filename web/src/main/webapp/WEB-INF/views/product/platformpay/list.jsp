...
<div class="page-header position-relative">
    ...
    <div class="header-buttons">
        ...
        </a> <a class="refresh" id="refresh-toggler" href="${ctx}/platform/pay/list"> <i
...
<!-- /Page Header -->
<!-- Page Body -->
<form action="${ctx}/platform/pay/list" method="post"
            ...
            <div class="col-xs-12 col-md-12">
                                ...
                                <div class="form-inline" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="type" style="width: 200px;">
                                            ...
                                            <option value="1">活期宝收益</option>
                                            <option value="2">定存宝收益</option>
                                            <option value="3">机构宝收益</option>
                                            <option value="4">私人订制收益</option>
                                            <option value="5">推荐收益返现</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                ...
                <div class="widget">
                    <div class="widget-header  with-footer">
                        <span class="widget-caption">平台支出列表</span>
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                ...
                                <c:forEach items="${page.content}" var="pay"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <c:choose>
                                                <c:when test="${pay.type eq 5}">

                                                    <fmt:formatNumber value="${empty pay.fund ? 0 : pay.fund*0.1 }"
                                                                      pattern="#" minFractionDigits='2'/>

                                                </c:when>
                                                <c:otherwise>
                                                    <c:out value="${empty pay.fund ? 0 : pay.fund }"/>
                                                </c:otherwise>
                                            </c:choose>

                                        </td>
                                        <td>
                                            <c:if test="${pay.type eq 1}">
                                                活期宝收益
                                            </c:if>
                                            <c:if test="${pay.type eq 2}">
                                                定存宝收益
                                            </c:if>
                                            <c:if test="${pay.type eq 3}">
                                                机构宝收益
                                            </c:if>
                                            <c:if test="${pay.type eq 4}">
                                                私人订制收益
                                            </c:if>
                                            <c:if test="${pay.type eq 5}">
                                                推荐收益返现
                                            </c:if>
                                        </td>
                                        <td><fmt:formatDate value="${pay.operationDate}" pattern="yyyy年MM月dd日"/></td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
