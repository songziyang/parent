...
<body>
	...
	<div class="page-header position-relative">
		...
		<div class="header-buttons">
			<a class="sidebar-toggler" href="#"> <i class="fa fa-arrows-h"></i>
				...
				href="${ctx}/product/netloantradelog/listNetloanTradelog"> <i
	...
	<!-- /Page Header -->
	<!-- Page Body -->
	<form action="${ctx}/product/netloantradelog/listNetloanTradelog"
				...
				<div class="col-xs-12 col-md-12">
									...
									<div class="form-inline" role="form">
										...
										<div class="form-group">
											<label class="control-label no-padding-right">状态</label> <select
												class="form-control" name="state" style="width: 100px;">
												<option value="1">预购中</option>
					...
					<div class="widget">
						<div class="widget-header  with-footer">
							<span class="widget-caption">网贷交易列表</span>
							<div class="widget-buttons">
									...
									<tbody style="font-size: 12px;">
										<c:forEach items="${page.content}" var="tradelog"
											...
											<tr>
												...
												<td><c:out value="${tradelog.netLoan.proName}" /></td>
												<td><fmt:formatDate value="${tradelog.tradeDateTime}"
														pattern="yyyy年MM月dd日" /></td>
												<td><c:out value="${tradelog.tradeMoney}" /></td>
												<td><c:out value="${tradelog.cycle}" /></td>
												<td><fmt:formatDate value="${tradelog.endDateTime}"
														pattern="yyyy年MM月dd日" /></td>
												<td><c:out value="${tradelog.interest}" /></td>
												<td><c:out value="${tradelog.profitMoney}" /></td>
												<td>
												...
												<c:if test="${ tradelog.state eq  6}">
													交易结束
												</c:if>
												</td>
												<td><fmt:formatDate value="${tradelog.createDateTime}"
