...
<body>
	...
	<div class="page-header position-relative">
		...
		<div class="header-buttons">
			<a class="sidebar-toggler" href="#"> <i class="fa fa-arrows-h"></i>
				...
				href="${ctx}/product/productsales/listDepositTransfer"> <i
	...
	<!-- /Page Header -->
	<!-- Page Body -->
	<form action="${ctx}/product/productsales/listDepositTransfer"
				...
				<div class="col-xs-12 col-md-12">
					...
					<div class="widget">
						<div class="widget-header  with-footer">
							<span class="widget-caption">银多2.0M购买列表</span>
							<div class="widget-buttons">
										...
										<c:forEach items="${page.content}" var="deposittransfer"
											...
											<tr>
												...
												<td>
													...
													<a href='${ctx}/userinfo/user/listUserInfo/<c:out value="${deposittransfer.user.id}" />'
														data-simpletooltip="init" title='<c:out value="${deposittransfer.user.remark}" />'
														<c:if test="${not empty deposittransfer.user.remark}">style='color: red;'</c:if>>
												...
												<td>
													<a href='${ctx}/userinfo/user/listUserInfo/<c:out value="${deposittransfer.user.id}" />'
													   data-simpletooltip="init" title='<c:out value="${deposittransfer.user.remark}" />'
													   <c:if test="${not empty deposittransfer.user.remark}">style='color: red;'</c:if>>
														<c:out value="${deposittransfer.user.mobile}" />
													</a>
												</td>
