			...
			<div style="width: 100%; height: 12%;">
					...
					<div class="col-sm-12">
						<div class="form-group">
							<span class="form-group input-icon icon-right"> <label
								class="labelt">提现金额<sup style="color: red;">&nbsp;*</sup>：
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							<span class="form-group input-icon icon-right"> <label
								class="labelt">确认提现<sup style="color: red;">&nbsp;*</sup>：
							</label> <input type="text" class="form-control" name="confirmFund"
								tabindex="1" style="padding-left: 120px;" required
								data-bv-identical="true" data-bv-identical-field="fund"
