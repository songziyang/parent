    ...
    <script type="text/javascript">
        ...
        function getViewsJSON() {
            return {
                ...
                "7": ["cylcleDays", "interestRate", "copies"],  //15天定存
                "8": ["cylcleDays", "interestRate", "copies"],   //自由定存
                "9": ["interestRate"],   //新手宝
                "10": ["cylcleDays", "interestRate", "copies"],   //新年福利包
            }
        }
...
<div class="page-header position-relative">
    <div class="header-title">
        <h1>
            <c:choose>
                <c:when test="${!empty productInfo.id}">产品信息编辑</c:when>
                ...
                <div class="widget-body">
                    <div id="registration-form">
                        <form action="${ctx}/product/productInfo/save" id="editForm"
                            ...
                            <input type="hidden" id="hid_cylcleDays"
                                   value="<c:out value='${productInfo.cylcleDays}' />"/>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" id="type" name="type.id"
                                                ...
                                                <c:if test="${productInfo.id ne null}">disabled</c:if>>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" name="productClas"
                                                <c:if test="${productInfo.id ne null}">disabled</c:if>>
                                            <option value="1"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6" id="cylcleDays">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" name="cylcleDays"></select>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
										<span class="form-group input-icon icon-right">
											...
											<input type="text" class="form-control" tabindex="1" id="name"
