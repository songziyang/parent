				...
				<div class="widget">
					...
					<div class="widget-body">
						<div id="registration-form">
							<form action="${ctx}/matchstock/trade/saveOption" id="editForm"
								name="editForm" method="post" role="form">
								<input type="hidden" name="fid"
									value='<c:out value="${trade.id}"/>'>
								<div class="form-title">股票买入</div>
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											<span class="form-group input-icon icon-right"> <label>可购金额：
											</label> <input type="text" class="form-control" tabindex="1"
												style="padding-left: 120px;" readonly="readonly"
												value="${trade.margin + trade.matchMoney}">
											</span>
										</div>
									</div>
									...
									<div class="col-sm-6">
										<div class="form-group">
											<span class="form-group input-icon icon-right"> <label>购买开始时间：
											</label> <input type="text" class="form-control" tabindex="1"
												style="padding-left: 120px;" value="${trade.buyStartDate}"
												readonly="readonly">
											</span>
										</div>
									</div>
									...
									<div class="col-sm-6">
										<div class="form-group">
											<span class="form-group input-icon icon-right"> <label>股票数量<sup
												...
												style="padding-left: 130px;" name="stockCount" required
												id="stockCount" maxlength="11" data-bv-stringlength-max="11"
									...
									<div class="col-sm-6">
										<div class="form-group">
											<span class="form-group input-icon icon-right"> <label>股票单价<sup
												...
												style="padding-left: 130px;" name="perValue" required
												id="perValue" maxlength="5" data-bv-stringlength-max="5"
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											<span class="form-group input-icon icon-right"> <label>购买时间<sup
													style="color: red;">&nbsp;*</sup>：
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											<span class="form-group input-icon icon-right"> <label>恒生HOMS账号：
											</label> <input type="text"  class="form-control"
												tabindex="1" style="padding-left: 130px;" name="homsAccount"
												maxlength="40" />
											</span>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											<span class="form-group input-icon icon-right"> <label>恒生HOMS密码：
											</label> <input type="text" class="form-control"
												tabindex="1" style="padding-left: 130px;" maxlength="40"
												name="homsPas" />
											</span>
										</div>
									</div>
