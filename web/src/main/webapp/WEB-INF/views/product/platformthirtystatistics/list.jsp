...
//                window.location.href ="http://localhost:8080/static/download/"+filename;
        ...
        function exprotExcel(condition) {
            var url = "${ctx}/platform/silverExchangeThirtyStatistics/exportExcel/" + condition
...
<div class="page-header position-relative">
    ...
    <div class="header-buttons">
        ...
        <a class="refresh" id="refresh-toggler" href="${ctx}/platform/silverExchangeThirtyStatistics/list">
...
<!-- /Page Header -->
<!-- Page Body -->
<form action="${ctx}/platform/silverExchangeThirtyStatistics/list" method="post" id="listForm" name="listForm">
    <div class="page-body">
        <div class="row">
                            ...
                            <table class="table table-hover table-striped table-bordered">
                                ...
                                <c:forEach items="${page.content}" var="statistics" varStatus="status">
                                    <tr>
                                        ...
                                        <td><c:out value="${statistics.allCount}"/></td>
                                        <td><c:out value="${statistics.goodsCount}"/></td>
                                        <td><fmt:formatDate value="${statistics.staDate}" pattern="yyyy年MM月dd日"/></td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
