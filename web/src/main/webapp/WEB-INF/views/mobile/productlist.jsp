		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div class="col-xs-6 text-right">
					<a href="${ctx}/product/productset/createProductSet" id="index"><span
						class="middle-span"></span><span>添加</span></a>
				</div>
				<div class="col-xs-12">
							...
							<div class="panel-heading" role="tab" id="headingList">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#list" href="#listData"
										aria-expanded="true" aria-controls="listData">产品设置</a>
								</h4>
							</div>
												...
												<c:forEach items="${page.content}" var="productset"
													...
													<li>
														<div class="block going">
															...
															<div class="time">
																<div class="left">
																	<span class="middle-span"></span> <span>产品名称</span>
																</div>
																<div class="right">
																	<span class="middle-span"></span> <span><c:out
																			value="${productset.product.name}" /></span>
																</div>
															</div>
															<div class="time">
																<div class="left">
																	<span class="middle-span"></span> <span>产品类型</span>
																</div>
																<div class="right">
												        ...
												        银多2.0+
															...
															<div class="status">
																<div class="left">
																	<span class="middle-span"></span> <span>发布份数</span>
																</div>
																<div class="right">
																	<span class="middle-span"></span> <span><c:out
																			value="${productset.circulation}" /></span>
																</div>
															</div>
															<div class="status">
																<div class="left">
																	<span class="middle-span"></span> <span>剩余份数</span>
																</div>
																<div class="right">
																	<span class="middle-span"></span> <span><c:out
																			value="${productset.remainingCopies}" /></span>
																</div>
															</div>
															<div class="status">
																<div class="left">
																	<span class="middle-span"></span> <span>发布利率</span>
																</div>
																<div class="right">
																	<span class="middle-span"></span> <span><c:out
																			value="${productset.apr}" /></span>
																</div>
															</div>
															<div class="status">
																<div class="left">
																	<span class="middle-span"></span> <span>活动利率</span>
																</div>
																<div class="right">
																	<span class="middle-span"></span> <span><c:out
																			value="${productset.activityApr}" /></span>
																</div>
															</div>
															<div class="status">
																<div class="left">
																	<span class="middle-span"></span> <span>发布时间</span>
																</div>
																<div class="right">
																	<span class="middle-span"></span> <span><fmt:formatDate
																			value="${productset.createDate}"
																			pattern="yyyy年MM月dd日  HH时mm分" /></span>
																</div>
															</div>
															<div class="details">
																<shiro:hasPermission name="productset_copy">
																	<div
																		style="width: 90%; height: 100%; float: left; text-align: right;">
																		<span class="middle-span"></span> <span class="text"><a
																			href='${ctx}/product/productset/copyProductSet/<c:out value="${productset.id}" />'>复制</a></span>
																	</div>
																</shiro:hasPermission>
															</div>
