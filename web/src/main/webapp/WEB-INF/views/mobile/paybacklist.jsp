							...
							<div class="panel-heading" role="tab" id="headingList">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#list" href="#listData"
										aria-expanded="true" aria-controls="listData"> 放款信息 </a>
								</h4>
							</div>
												...
												<c:forEach items="${page.content}" var="payback"
													...
													<li>
														<div class="block going">
															...
															<div class="details">
																<c:if test="${payback.status == 3}">
																	<shiro:hasPermission name="withdraws_detailed">
																		<div style="width: 50%; height: 100%; float: left">
																			<span class="middle-span"></span> <span class="text"><a
																				href='${ctx}/userwithdraw/paback/findWithDrawByID/<c:out value="${payback.id}"/>'>放款</a></span>
																		</div>
																	</shiro:hasPermission>
																</c:if>
																<c:if
																	test="${payback.status == 4 || payback.status == 5}">
																	<shiro:hasPermission name="withdraws_detailed">
																		<div style="width: 50%; height: 100%; float: left">
																			<span class="middle-span"></span> <span class="text"><a
																				href='${ctx}/userwithdraw/paback/findWithDrawByID/<c:out value="${payback.id}"/>'>查看</a></span>
																		</div>
																	</shiro:hasPermission>
																</c:if>
																<shiro:hasPermission name="withdraw_buniessdetailed">
																	<div style="width: 50%; height: 100%; float: left">
																		<span class="middle-span"></span> <span class="text"><a
																			href='${ctx}/userwithdraw/withdraw/userinfobyid/<c:out value="${payback.user.id}"/>/1'>用户信息</a></span>
																	</div>
																</shiro:hasPermission>
															</div>
