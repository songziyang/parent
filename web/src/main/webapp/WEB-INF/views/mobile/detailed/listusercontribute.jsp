							...
							<div class="panel-heading" role="tab" id="headingList">
								<h4 class="panel-title">
									<a data-toggle="collapse" data-parent="#list" href="#listData"
										aria-expanded="true" aria-controls="listData">贡献值列表 </a>
								</h4>
							</div>
												...
												<c:forEach items="${page.content}" var="contribution"
													...
													<li>
														<div class="block going">
															...
															<div class="status">
																<div class="left">
																	<span class="middle-span"></span> <span>贡献值份数</span>
																</div>
																<div class="right">
																	<span class="middle-span"></span> <span><c:out
																			value="${contribution.score}" /></span>
																</div>
															</div>
															<div class="status">
																<div class="left">
																	<span class="middle-span"></span> <span>可用份数</span>
																</div>
																<div class="right">
																	<span class="middle-span"></span> <span><c:out
																			value="${contribution.usableScore}" /></span>
																</div>
															</div>
															<div class="status">
																<div class="left">
