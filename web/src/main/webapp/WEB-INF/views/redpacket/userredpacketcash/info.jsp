...
<div class="page-header position-relative">
    ...
    <div class="header-buttons">
        ...
        <a class="refresh" id="refresh-toggler" href="${ctx}/redpacket/userRedpacketCash/${redpacketId}">
                    ...
                    <div class="widget-body">
                        <div class="flip-scroll">
                            <div style="text-align: right; margin-bottom: 10px;">
                                <a href="${ctx}/redpacket/userRedpacketCash/list" class="btn btn-labeled btn-blue">
                                ...
                                <tbody style="font-size: 12px;">
                                    <c:forEach items="${page.content}" var="userRp" varStatus="status">
                                        <tr>
                                            ...
                                            <td><c:out value="${userRp.giveValue}" /></td>
                                            <td>
                                                <c:choose>
