	...
	function checkradio() {
		...
		if (len > 0) {
			...
			if (result > 0) {
				...
				var address = "${ctx}/redpacket/sendIntegral/sendIntegral?id=" + id;
				bootbox.dialog({
					message : "您确定要发送此积分么？",
					title : "积分发放提示",
				...
				Notify("对不起无符号条件的用户，您不能进行积分发放！", 'top-left', '5000', 'warning',
						'fa-warning', true);
			}
		} else {
			Notify("请选择要发放的积分！", 'top-left', '5000', 'warning', 'fa-warning',
					true);
		}
	}
</script>
...
<body>
	...
	<div class="page-header position-relative">
		...
		<div class="header-buttons">
			...
			<a class="refresh" id="refresh-toggler" href="${ctx}/redpacket/sendIntegral/send">
	...
	<!-- /Page Header -->
	<!-- Page Body -->
	<form action="${ctx}/redpacket/sendIntegral/querySendUserCount"
							...
							<div class="flip-scroll">
								<div style="text-align: right; margin-bottom: 10px;">
									...
									<a class="btn btn-labeled btn-success"
										...
										class="btn-label glyphicon glyphicon-envelope"></i>积分发放</a>
								</div>
								...
								<table class="table table-hover table-striped table-bordered">
									...
									<tbody style="font-size: 12px;">
										<c:forEach items="${integrals}" var="integral" varStatus="status">
											<tr>
