...
<div class="page-header position-relative">
    ...
    <div class="header-buttons">
        ...
        <a class="refresh" id="refresh-toggler" href="${ctx}/redpacket/sendIntegral/list">
                            ...
                            <div style="text-align: right;margin-bottom: 10px;">
                                <shiro:hasPermission name="userrp_give">
                                    <a class="btn btn-labeled btn-success"
                                       href="${ctx}/redpacket/sendIntegral/send">
                                        <i class="btn-label glyphicon glyphicon-envelope"></i>积分发放
                                    </a>
                                </shiro:hasPermission>
                            </div>
                                    ...
                                    <c:forEach items="${page.content}" var="integral" varStatus="status">
                                        <tr>
                                            ...
                                            <td width="200px" align="center">
                                                <shiro:hasPermission name="sendintegral_info">
                                                    <a href='${ctx}/redpacket/sendIntegral/<c:out value="${integral.id}"/>'
