...
<div class="page-header position-relative">
    ...
    <div class="header-buttons">
        ...
        <a class="refresh" id="refresh-toggler" href="${ctx}/redpacket/redpacketCash/list">
...
<!-- /Page Header -->
<!-- Page Body -->
<form action="${ctx}/redpacket/redpacketCash/list" method="post" id="listForm" name="listForm">
    <div class="page-body">
        <div class="row">
                    ...
                    <div class="widget-body">
                        <div class="flip-scroll">
                            <div style="text-align: right;margin-bottom: 10px;">
                                <shiro:hasPermission name="rpCash_create">
                                    <a class="btn btn-labeled btn-success" href="${ctx}/redpacket/redpacketCash/create" >
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <c:choose>
                                                    ...
                                                    <c:when test="${cash.triggerType eq 30}">4.0推荐活动</c:when>
                                                </c:choose>
                                            </td>
                                            ...
                                            <td width="200px" align="center">
                                                <shiro:hasPermission name="rpcash_edit">
                                                    <a href='${ctx}/redpacket/redpacketCash/edit/<c:out value="${cash.id}" />' class="btn btn-info btn-xs edit">
                                                        <i class="fa fa-edit"></i>编辑
                                                    </a>
                                                    &nbsp;&nbsp;
                                                </shiro:hasPermission>
                                                <shiro:hasPermission name="rpcash_del">
                                                    <c:if test="${cash.status eq 0}">
                                                        <a class="btn btn-danger btn-xs delete" onclick="disableCash('${ctx}/redpacket/redpacketCash/disable/<c:out value="${cash.id}" />')">
                                                            <i class="fa fa-trash-o"></i>停用
                                                        </a>
                                                    </c:if>
                                                    <c:if test="${cash.status eq 1}">
                                                        <a class="btn btn-danger btn-xs delete" onclick="enableCash('${ctx}/redpacket/redpacketCash/enable/<c:out value="${cash.id}" />')">
