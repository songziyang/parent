        ...
        function checkradio() {
            ...
            if (len > 0) {
                ...
                if (result > 0) {
                    ...
                    var address = "${ctx}/redpacket/expmoneysend/sendmoney/" + id;
                    bootbox.dialog({
                        message: "您确定要发送体验金么？",
                        title: "体验金发放提示",
...
<div class="page-header position-relative">
    ...
    <div class="header-buttons">
        ...
        <a class="refresh" id="refresh-toggler" href="${ctx}/redpacket/expmoneysend/querySendUserCount">
...
<form action="${ctx}/redpacket/expmoneysend/querySendUserCount" method="post" id="listForm" name="listForm">
    <div class="page-body">
        <div class="row">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="form-inline" role="form">
                                    ...
                                    <div class="form-group">
                                        &nbsp;&nbsp;推荐人数&nbsp;
                                        <input type="text" name="refStartNum"
                                                value="${condition.refStartNum}" class="form-control"
                                                tabindex="1" style="padding-left: 10px;width: 100px;" maxlength="40">
                                        &nbsp;到&nbsp;
                                        <input type="text" name="refEndNum"
                    ...
                    <div class="widget-body">
                        <div class="flip-scroll">
                            <div style="text-align: right; margin-bottom: 10px;">
                                <div style="text-align: center; color: red; font-size: 15px" id="result">
                                    当前选中人数为<c:out value="${empty currentPerson  ? 0 : currentPerson}"/>
                                </div>
                                <a class="btn btn-labeled btn-success" href="javascript:checkradio();">
                                    <i class="btn-label glyphicon glyphicon-envelope"></i>体验金发放
                                </a>
                            </div>
                            <table class="table table-hover table-striped table-bordered">
                                ...
                                <c:forEach items="${page}" var="expMoney" varStatus="status">
                                    <tr>
                                        <td style="text-align: center;">
                                            <label>
                                                <input name="form-field-radio" type="radio" class="colored-blue" value="${expMoney.id }">
                                        ...
                                        <td>
                                            <c:if test="${expMoney.isSend eq 0  }">是</c:if>
                                            <c:if test="${expMoney.isSend eq 1  }">否</c:if>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
