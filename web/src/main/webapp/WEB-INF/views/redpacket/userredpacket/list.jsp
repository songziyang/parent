...
<div class="page-header position-relative">
    ...
    <div class="header-buttons">
        ...
        <a class="refresh" id="refresh-toggler" href="${ctx}/redpacket/userRedpacket/list">
                            ...
                            <div style="text-align: right;margin-bottom: 10px;">
                                <shiro:hasPermission name="userrp_give">
                                    <a class="btn btn-labeled btn-success"
                                       href="${ctx}/redpacket/userRedpacket/send">
                                        ...
                                        <tr>
                                            ...
                                            <td width="200px" align="center">
                                                <shiro:hasPermission name="userrp_info">
                                                    <a href='${ctx}/redpacket/userRedpacket/<c:out value="${interest.id}"/>'
