...
cityArray[34] = new Array("上海");
$(function () {
    var province = document.getElementById('province');
    if(province.length == 0){
        province.length = 0;
        province.options[0] = new Option('请选择', '0');
        document.getElementById('city').options[0] = new Option('请选择', '0');
    }
    for (var i = 1; i < cityArray.length; i++) {
        province.options[province.length] = new Option(cityArray[i][0], cityArray[i][0]);
    }
})
