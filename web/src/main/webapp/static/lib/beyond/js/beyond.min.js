...
function InitiateSideMenu() {
    $(".sidebar-toggler").on("click", function () {
        return $(window.parent.document).find("#sidebar").toggleClass("hide"), $(".sidebar-toggler").toggleClass("active"), !1
    });
...
$("#fullscreen-toggler").on("click", function () {
    var n = window.parent.document.documentElement;
