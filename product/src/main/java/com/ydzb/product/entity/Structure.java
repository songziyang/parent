...
@DynamicInsert
@DynamicUpdate
public class Structure extends BaseEntity<Long> {
    ...
    public static final int STATE_ALLOT = 1;   //申购中
    ...
    public Date getsDate() {
        return DateUtil.getSystemTimeMillisecond(startDate);
    }

    public Date geteDate() {
        return DateUtil.getSystemTimeMillisecond(endDate);
    }

    public Date getfDate() {
        return DateUtil.getSystemTimeMillisecond(fullDate);
    }
