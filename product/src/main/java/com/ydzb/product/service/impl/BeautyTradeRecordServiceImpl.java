...
import com.ydzb.product.repository.BeautyTradeRecordRepository;
 ...
 */
@Service
public class BeautyTradeRecordServiceImpl extends BaseServiceImpl<BeautyTradeRecord, Long> implements IBeautyTradeRecordService {

    @Autowired
    private BeautyTradeRecordRepository beautyTradeRecord;
    ...
    public List<Object[]> findExportData(Map<String, Object> filter) {
        return beautyTradeRecord.findExportData(filter);
    }
    ...
    public String exportExcel(List<Object[]> datas, String address) {
        ...
        try {
            ...
            fileName = "/beautyrecord" + DateUtil.getSystemTimeSeconds() + ".xls";
            String filePath = address + fileName;
            POIUtil.exportExcel2FilePath("美利金融交易记录", filePath, headInfoList, dataList);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return fileName;
